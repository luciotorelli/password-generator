...
def get_password_length():
    ...
    print(
        "Hey there! I am passgen, a very basic bot ",
        "that will generate a password for you.",
    )
    print(
        "Please enter how many characters you want your",
        "password to have, select a number between 3 and 100.\n",
    )
    ...
    while True:
        try:
            ...
            password_length = int(input(
                "Enter your number here and hit enter:\n"))
            ...
            # Check if the user selected 1 or
            # more characters to phrase the result correctly
            if password_length == 1:
                print(
                    f"You selected {password_length} character")
            else:
                print(
                    f"You selected {password_length} characters")
...
def get_password_strength():
    ...
    print(
        ...
        "For most security I would recommend level 3! :) \n",
    )
    print(
    ...
    print(
        "Level 3: Letters, numbers and characters")

    print(
        "You should type a number between 1 to 3.\n")
    ...
    while True:
        try:
            ...
            # Make input integer
            password_strength = int(input(
                "Enter your level here:\n"))
...
def print_password(password):
    ...
    print(
        "...")
    # Pauses the program for 2 seconds then resumes.
    time.sleep(
        2)
    print(
        "...")
    # Pauses the program for 4 seconds then resumes.
    time.sleep(
        3)
    print(
        "I hope you are still there, working hard on this...")
    print(
        "...")
    # Pauses the program for 4 seconds then resumes.
    time.sleep(
...
def main():
    ...
    password = generate_password(
        password_length, password_strength)
    print_password(
        password)
